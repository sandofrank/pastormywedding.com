...
export default function ReviewsPage() {
  return (
    <main>
      <section className="page-hero-image page-hero-reviews">
        <div className="container">
          <h1>Reviews &amp; Testimonials</h1>
          <p>What couples are saying about Pastor Jeff</p>
        </div>
      </section>
      ...
      <section className="section section-alt">
        <div className="container">
          <div className="section-header">
            <h2>Moments We&apos;ve Shared</h2>
            <p>Beautiful ceremonies from couples Pastor Jeff has had the honor of marrying</p>
          </div>
          <div className="photo-gallery">
            <div className="photo-gallery-item">
              <Image src="/images/wed8.jpg" alt="Wedding ceremony at Temecula winery" fill sizes="(max-width: 600px) 100vw, (max-width: 900px) 50vw, 33vw" className="photo-gallery-fill" />
            </div>
            <div className="photo-gallery-item">
              <Image src="/images/wed7.png" alt="Couple exchanging vows" fill sizes="(max-width: 600px) 100vw, (max-width: 900px) 50vw, 33vw" className="photo-gallery-fill" />
            </div>
            <div className="photo-gallery-item">
              <Image src="/images/couple1.png" alt="Happy couple after ceremony" fill sizes="(max-width: 600px) 100vw, (max-width: 900px) 50vw, 33vw" className="photo-gallery-fill" />
            </div>
          </div>
        </div>
      </section>
